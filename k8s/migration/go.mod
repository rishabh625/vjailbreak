...
require (
	...
	github.com/platform9/vjailbreak/v2v-helper v0.0.0-20250630122603-a9acfd247657
...
replace github.com/platform9/vjailbreak/v2v-helper v0.0.0-20250630122603-a9acfd247657 => ../../v2v-helper
